# Generated by Django 4.0 on 2022-09-29 12:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('roles', models.CharField(blank=True, choices=[('T', 'Преподаватель'), ('S', 'Студент'), ('E', 'Староста')], max_length=2, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('direction', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Students.typedirection', verbose_name='Направление')),
